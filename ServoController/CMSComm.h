...
class CMSComm : public COleDispatchDriver
{
public:
	CMSComm() {} // Calls COleDispatchDriver default constructor
	CMSComm(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMSComm(const CMSComm& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
